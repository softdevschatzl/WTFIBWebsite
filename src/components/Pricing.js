...
const Pricing = () => {
  const [plans, setPlans] = useState([
    ...
    { id: 3, name: 'Unlimited Stems', price: 100, features: ['- Unlimited Distribution and Streaming Rights', '- Untagged WAV/MP3 and Track Stems'], bgColor: '#290d44' } ,
    { id: 4, name: 'Unlimited MP3/WAV', price: 60, features: ['- Untagged Beat WAV/MP3', '- Unlimited Distribution and Streaming Rights'], bgColor: '#290d44' },
    ...
    { id: 6, name: 'Exclusive License', price: 250, features: ['- Exclusive Track Stem License (Unlimited)'], bgColor: '#290d44' },
  ]);
